...
(22,	'cheese',	'fromage'),
(23,	'',	''),
(24,	'biologique',	'un délice');

DROP TABLE IF EXISTS `commande`;
CREATE TABLE `commande` (
  `id` varchar(300) NOT NULL,
  `nom_client` varchar(200) CHARACTER SET utf8 NOT NULL,
...
INSERT INTO `commande` (`id`, `nom_client`, `prenom_client`, `mail_client`, `livraison`, `token`, `etat`) VALUES
('552d1172-efd0-11e7-b5e5-d102ddca12eb',	'',	'',	'',	'0',	'347c00060771affd1ec9cc9e453e25fd23c212bf6140bff7a138ccdea6c2df0e',	'non traité'),
('9e0dce60-efd8-11e7-8ef8-6bfdd66674eb',	'dumas',	'yann',	'yanndumas@gmail.fr',	'0',	'8b4d59b9fd1cc24c8c40357880316f0b9b4b683362462fc3980f797ca1de96c8',	'non traité'),
('1bcec64c-efd9-11e7-bf3c-d7cb32262a99',	'dumas',	'yann',	'yanndumas@gmail.fr',	'0',	'73c95f5bfbd3892bc08c899b80010710cbd4a3460404bc56bacd69d5c49d9d08',	'non traité');
